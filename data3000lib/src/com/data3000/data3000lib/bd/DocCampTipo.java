 ...
 */
public class DocCampTipo extends RegistroTabla implements java.io.Serializable {
	...
	public static List<CampoTabla> getCamposTabla() {
		String[] camposMostrar = new String[]{"docCampo","campTipoRequerido","campTipoOrden"};
